...
-- This script creates realistic quotations for each service with specific dates (10-12 October 2025)
-- Uses actual service provider IDs, job cart IDs, and service IDs from the existing database

-- Note: This script assumes the existing service providers, job carts, and services are already in the database
-- We will use the actual foreign keys from the existing data

-- First, let's create additional job carts for each service using existing events
...
-- Job carts for existing events with all 30 services
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Hair Styling & Makeup', 'Professional hair styling and makeup for wedding', '2025-10-10', '09:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Makeup & Hair', 'Complete makeup and hair service for bride', '2025-10-10', '10:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Photography', 'Wedding photography package', '2025-10-10', '11:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Makeup Artist', 'Professional makeup artist for wedding party', '2025-10-10', '12:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Videography', 'Wedding videography service', '2025-10-10', '13:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'DJ Services', 'Wedding DJ and music service', '2025-10-10', '14:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Catering', 'Wedding catering service', '2025-10-10', '15:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Decoration', 'Wedding decoration and setup', '2025-10-10', '16:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Venue', 'Wedding venue rental', '2025-10-10', '17:00:00', 'pending', NOW()),
(gen_random_uuid(), '7cc2dfbe-55b5-45b2-b61e-c49f0d401bf2', 'Florist', 'Wedding floral arrangements', '2025-10-10', '18:00:00', 'pending', NOW()),

-- Job carts for second event (Birthday Party)
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'MC', 'Birthday party MC service', '2025-10-11', '09:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Security', 'Birthday party security', '2025-10-11', '10:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Sound System', 'Birthday party sound system', '2025-10-11', '11:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Lighting', 'Birthday party lighting', '2025-10-11', '12:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Transport', 'Birthday party transport', '2025-10-11', '13:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Event Planning', 'Birthday party planning', '2025-10-11', '14:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Event Coordination', 'Birthday party coordination', '2025-10-11', '15:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Event Management', 'Birthday party management', '2025-10-11', '16:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Hair Styling', 'Birthday party hair styling', '2025-10-11', '17:00:00', 'pending', NOW()),
(gen_random_uuid(), 'c755ba4a-d889-49b1-9eb5-1f1dc9340969', 'Hair Stylist', 'Birthday party hair stylist', '2025-10-11', '18:00:00', 'pending', NOW()),

-- Job carts for third event (Matric Dance)
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Photographer', 'Matric dance photographer', '2025-10-12', '09:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Photo Booth', 'Matric dance photo booth', '2025-10-12', '10:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Musician', 'Matric dance musician', '2025-10-12', '11:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'DJ', 'Matric dance DJ', '2025-10-12', '12:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Music', 'Matric dance music service', '2025-10-12', '13:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Caterer', 'Matric dance caterer', '2025-10-12', '14:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Stage Design', 'Matric dance stage design', '2025-10-12', '15:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Decorator', 'Matric dance decorator', '2025-10-12', '16:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Flowers', 'Matric dance flowers', '2025-10-12', '17:00:00', 'pending', NOW()),
(gen_random_uuid(), 'aa8b7c83-78cd-40cd-bf6e-216b45c5c867', 'Event Planning', 'Matric dance planning', '2025-10-12', '18:00:00', 'pending', NOW());

-- Now create quotations using the existing service providers and the new job carts
...
-- 1. Creates job carts for all 30 services using existing event IDs
-- 2. Generates quotations using actual service provider IDs from the database
-- 3. Matches service providers to appropriate services based on service type
-- 4. Uses realistic pricing and detailed descriptions for each service
-- 5. Sets specific dates (10-12 October 2025) as requested
-- 6. Creates at least 3 quotations per service
-- 7. Uses actual foreign keys from the existing database structure
