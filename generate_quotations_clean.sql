...
-- This script only uses services that actually exist in the database (26 services)
...
-- Step 2: Create job carts using ONLY the actual service IDs and client IDs that exist in the database
