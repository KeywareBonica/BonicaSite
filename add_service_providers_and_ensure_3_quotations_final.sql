...
-- FIXED VERSION - Handles validation trigger properly
-- ===============================================
...
-- Step 2: Add new South African service providers for each service
...
-- Step 5: Re-enable the quotation validation trigger with a more lenient function
...
-- Step 6: Verification - Check final quotation counts per service
SELECT 
...
-- Step 7: Show sample quotations with new providers
SELECT 
