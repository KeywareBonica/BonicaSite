-- === SUPABASE MIGRATION - SIMPLE APPROACH ===
-- This script adds new functionality without converting existing columns to enums
-- This avoids all the enum conversion issues
...
BEGIN
  IF (TG_OP = 'UPDATE') 
    ...
    SET accepted_quotation_id = NEW.quotation_id,
        job_cart_status = 'accepted'  -- Keep as text for now
