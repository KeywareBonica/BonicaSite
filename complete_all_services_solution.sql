-- ===============================================
-- COMPLETE SOLUTION: Job Carts + Quotations for ALL Services
-- ===============================================
...
-- Step 4: Add service providers for ALL services
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Thandi', 'Nkosi', 'password123', '083 234 5678', 'thandi.nkosi@email.com', 'Rosebank', 4.6, 'Beauty', true, NOW()
FROM service s WHERE s.service_name = 'Hair Styling & Makeup'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Lerato', 'Molefe', 'password123', '085 456 7890', 'lerato.molefe@email.com', 'Johannesburg', 4.7, 'Media', true, NOW()
FROM service s WHERE s.service_name = 'Photography'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Zanele', 'Khumalo', 'password123', '087 678 9012', 'zanele.khumalo@email.com', 'Rosebank', 4.5, 'Media', true, NOW()
FROM service s WHERE s.service_name = 'Videography'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Nomsa', 'Zulu', 'password123', '089 890 1234', 'nomsa.zulu@email.com', 'Johannesburg', 4.6, 'Food & Beverage', true, NOW()
FROM service s WHERE s.service_name = 'Catering'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Precious', 'Nkosi', 'password123', '091 012 3456', 'precious.nkosi@email.com', 'Rosebank', 4.8, 'Design', true, NOW()
FROM service s WHERE s.service_name = 'Decoration'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'DJ', 'Sbu', 'password123', '093 234 5678', 'dj.sbu@email.com', 'Johannesburg', 4.5, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'DJ Services'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Samuel', 'Van Heerden', 'password123', '095 456 7890', 'samuel.vanheerden@email.com', 'Rosebank', 4.7, 'Venue', true, NOW()
FROM service s WHERE s.service_name = 'Venue'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Pieter', 'Botha', 'password123', '097 678 9012', 'pieter.botha@email.com', 'Johannesburg', 4.8, 'Security', true, NOW()
FROM service s WHERE s.service_name = 'Security'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Michael', 'Smith', 'password123', '099 890 1234', 'michael.smith@email.com', 'Rosebank', 4.7, 'Planning', true, NOW()
FROM service s WHERE s.service_name = 'Event Planning'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'David', 'Brown', 'password123', '011 012 3456', 'david.brown@email.com', 'Johannesburg', 4.6, 'Design', true, NOW()
FROM service s WHERE s.service_name = 'Florist'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'MC', 'Lebo', 'password123', '013 234 5678', 'mc.lebo@email.com', 'Rosebank', 4.7, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'MC'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Lisa', 'Anderson', 'password123', '015 456 7890', 'lisa.anderson@email.com', 'Johannesburg', 4.6, 'Beauty', true, NOW()
FROM service s WHERE s.service_name = 'Makeup & Hair'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Michelle', 'White', 'password123', '017 678 9012', 'michelle.white@email.com', 'Rosebank', 4.9, 'Beauty', true, NOW()
FROM service s WHERE s.service_name = 'Makeup Artist'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'William', 'Garcia', 'password123', '019 890 1234', 'william.garcia@email.com', 'Johannesburg', 4.5, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'Sound System'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Christopher', 'Martinez', 'password123', '021 012 3456', 'christopher.martinez@email.com', 'Rosebank', 4.8, 'Design', true, NOW()
FROM service s WHERE s.service_name = 'Stage Design'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Matthew', 'Lee', 'password123', '023 234 5678', 'matthew.lee@email.com', 'Johannesburg', 4.9, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'Photo Booth'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Mark', 'Thompson', 'password123', '025 456 7890', 'mark.thompson@email.com', 'Rosebank', 4.7, 'Beauty', true, NOW()
FROM service s WHERE s.service_name = 'Hair Styling'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Steven', 'Anderson', 'password123', '027 678 9012', 'steven.anderson@email.com', 'Johannesburg', 4.8, 'Design', true, NOW()
FROM service s WHERE s.service_name = 'Lighting'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Andrew', 'Jackson', 'password123', '029 890 1234', 'andrew.jackson@email.com', 'Rosebank', 4.7, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'Musician'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Kenneth', 'Harris', 'password123', '031 012 3456', 'kenneth.harris@email.com', 'Johannesburg', 4.6, 'Food & Beverage', true, NOW()
FROM service s WHERE s.service_name = 'Caterer'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Brian', 'Garcia', 'password123', '033 234 5678', 'brian.garcia@email.com', 'Rosebank', 4.5, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'DJ'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Timothy', 'Robinson', 'password123', '035 456 7890', 'timothy.robinson@email.com', 'Johannesburg', 4.8, 'Design', true, NOW()
FROM service s WHERE s.service_name = 'Decorator'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Jason', 'Rodriguez', 'password123', '037 678 9012', 'jason.rodriguez@email.com', 'Rosebank', 4.9, 'Design', true, NOW()
FROM service s WHERE s.service_name = 'Flowers'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Jacob', 'Lee', 'password123', '039 890 1234', 'jacob.lee@email.com', 'Johannesburg', 4.7, 'Entertainment', true, NOW()
FROM service s WHERE s.service_name = 'Music'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Nicholas', 'Hall', 'password123', '041 012 3456', 'nicholas.hall@email.com', 'Rosebank', 4.6, 'Media', true, NOW()
FROM service s WHERE s.service_name = 'Photographer'
...
UNION ALL SELECT gen_random_uuid(), s.service_id, 'Jonathan', 'Young', 'password123', '043 234 5678', 'jonathan.young@email.com', 'Johannesburg', 4.7, 'Beauty', true, NOW()
FROM service s WHERE s.service_name = 'Hair Stylist'
